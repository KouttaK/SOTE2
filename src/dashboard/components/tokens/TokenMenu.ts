...
const MENU_ITEMS = [
  { type: 'choice', icon: 'M64 144a48 48 0 1 0 0-96 48 48 0 1 0 0 96zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192z' },
  { type: 'cursor', icon: 'M0 55.2V426c0 12.2 9.9 22 22 22c4.6 0 8.9-1.4 12.5-3.9l98.8-67.9l46.2 80c3.9 6.7 10.3 11.5 17.8 13.3s15.3-.2 21.3-5.2l29.4-24.8c8.3-7 11.2-18.7 7-28.7l-42.3-100.9l98.8 32c10.8 3.5 22.8-1.5 27.8-11.8c4.9-10.1 2.3-22.3-6.1-29.6l-297-251C30.6 44 21.6 46.1 14.8 53S0 67.5 0 77.2V55.2z', viewbox: '0 0 320 512' },
  { type: 'clipboard', icon: 'M192 0c-41.8 0-77.4 26.7-90.5 64H64C28.7 64 0 92.7 0 128V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V128c0-35.3-28.7-64-64-64H282.5C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM112 192H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z', viewbox: '0 0 384 512' },
...
export class TokenMenu {
  ...
  private render() {
    ...
    MENU_ITEMS.forEach(item => {
      const isDisabled = this.disabledTypes.has(item.type as Token['type']);
